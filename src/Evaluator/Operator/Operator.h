...
namespace Evaluator {
    namespace Operator
    {
        struct Result {
            ...
            Result(Expr e, bool exit) : expr(e), flags(exit << 7), error_code(0) {}
            Result(Expr e, bool jump) : expr(e), flags(jump << 6), error_code(0) {}
            Result(Expr e, unsigned int ec) : expr(e), flags(0xA0), error_code(ec) {}

            bool ExitFlag() { return flags & 0x80; }
            bool JumpFlag() { return flags & 0x40; }
            bool ErrorFlag() { return flags & 0x20; }
        };
        ...
        Expr(* const FUNC[NUM_OPS])(const Expr&, const Expr&, Context*) = {
            Literal::False,              // !
            Object::Access_l_r,          // .
            Object::Access_r,            // .
            Object::Access,              // .
